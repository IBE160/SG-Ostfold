...
production, incidents, safety data, and other shift-specific details are properly recorded and made available for managers and KPIs.
...
- Server action implemented with Supabase insert.
